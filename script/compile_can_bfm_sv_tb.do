...
quietly set compdirectives_vlog "-mixedsvvh s -93 -suppress 1346,1236 -quiet -work $lib_name +incdir+$util_part_path/src/can_ctrl/ +incdir+$util_part_path/src/bfm/can_bfm_sv/"

echo "\n\n\n=== Compiling $lib_name source\n"

eval vlog  $compdirectives_vlog   $util_part_path/src/tb/can_bfm_sv_tb.sv
